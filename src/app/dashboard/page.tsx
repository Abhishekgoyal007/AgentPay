                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[var(--text-secondary)] ml-2">
                                            Transactions are simulated. Set NEXT_PUBLIC_PRIVY_APP_ID to enable real wallets.
                                        </span>
                                    </div>
                                </div>
                                <button
                                    ...
                                    disabled={isFunding}
                                    className="px-4 py-2 rounded-lg bg-[var(--accent-warning)]/20 text-[var(--accent-warning)] hover:bg-[var(--accent-warning)]/30 transition-colors text-sm font-medium"
                                >
                                    {isFunding ? 'Adding...' : '+ Get 10 MOVE'}
                                </button>
                            </div>
                        </div>
                    )}
